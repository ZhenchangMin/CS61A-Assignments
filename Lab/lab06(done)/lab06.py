...
class Mint:
    ...
    def __init__(self):
        self.update()
        self.year = self.present_year # It remains 2024 when we changed Mint.present_year because it is initialized only once, not sync. 
        # So after __init__ is called, year is bound to 2024 and we didn't change until update() method is called.
