...
def digit_distance(n):
    ...
    if n < 10:
        ...
        return abs(n % 10 - (n // 10))  # last digit - first digit
    else:
        last = n % 10
        but_last = n % 100 // 10
        return abs(last - but_last) + digit_distance(n // 10)
...
def interleaved_sum(n, odd_func, even_func):
    ...
    if n % 2 == 1:
        ...
        return even_func(n) + interleaved_sum(n - 1, odd_func, even_func)#Wrong answer, because mod operation is banned
    """Solution:
    def sum_from(k):
        if k > n:
            return 0
...
def count_dollars(total):
    ...
    def helper(amount, current_bill):
        ...
        return helper(amount, next_bill) + helper(amount - current_bill, current_bill)
...
def count_dollars_upward(total):
    ...
    def helper(amount, current_bill):
        ...
        if amount < 0:
            return 0
        if current_bill == 100:
            return helper(amount - current_bill, current_bill)
...
def move_stack(n, start, end):
    ...
    if n == 1:
        ...
        # Find the auxiliary pole (not start or end)
